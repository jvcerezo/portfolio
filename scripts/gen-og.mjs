...
<svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 630">
  ...
  <!-- Subtitle -->
  <text x="72" y="435" font-size="32" font-family="'Helvetica Neue','Arial',sans-serif" font-weight="500" fill="#ffffff" fill-opacity="0.64" letter-spacing="-0.5">Software Engineer  ·  Full-Stack &amp; Mobile  ·  Philippines</text>
